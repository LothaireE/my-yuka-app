...
const NutriScore = (nutriscore) => {
  //   console.log("energy==>", nutriscore.nutriscore.energy_value);
  //   console.log("fat==>", nutriscore.nutriscore.fat_value);
  //   console.log("fiber==>", nutriscore.nutriscore.fiber_value);
  //   console.log("proteins==>", nutriscore.nutriscore.proteins_value);
  //   console.log("salt==>", nutriscore.nutriscore.salt_value);
  //   console.log("sugar==>", nutriscore.nutriscore.sugars_value);
